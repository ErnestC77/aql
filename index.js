...
function parseInputLine(text) {
  ...
  // Пример с окончанием: TVR4701, 01.05.2026, ER-BAS, HKG, Ernest / PAXSTEP, 10:00, 12:30 / GPU, 12:45, 15:20
  // Пример без окончания: TVR4701, 01.05.2026, ER-BAS, HKG, Ernest / PAXSTEP, 10:00 / GPU, 12:45
...
Допустимое оборудование (примеры):
${equipmentList.join(", ")}`);
      await goToMainMenu(from, session);
      return;
    }
